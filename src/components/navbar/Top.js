...
export const Top = () => {
  return (
    <Navbar expand="lg" style={{ borderBottom: "1px solid lightgrey" }}>
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll" className="mt-2">
          <Nav
            ...
            navbarScroll
          >
            <Nav.Link href="#action1" style={{ fontSize: "16px" }}>
              Collections
            </Nav.Link>
          ...
          <Button variant="outline-light" className="pe-3">
            <img src={imageAvatar} alt="" width="50px" />
          </Button>
        </Navbar.Collapse>
      </Container>
    </Navbar>
